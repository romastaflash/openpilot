...
A_CRUISE_MIN = -3.2
A_CRUISE_MAX_VALS = [1.2, 1.7, 1.8, 2.0, 2.1] if Params().get_bool('CommaPedalEnhancements') else [1.2, 1.2, 0.8, 0.6]
A_CRUISE_MAX_BP = [0., 5., 11., 24., 37.] if Params().get_bool('CommaPedalEnhancements') else [0., 15., 25., 40.]
